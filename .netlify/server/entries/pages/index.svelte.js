...
const Servce = (0, import_index_cb93fe8d.c)(($$result, $$props, $$bindings, slots) => {
	...
	return `<a${(0, import_index_cb93fe8d.a)(
		'href',
		url,
		0
	)} class="${'svelte-14r4rp3'}"><h3 style="${
		'background-color:' + (0, import_index_cb93fe8d.e)(bg) + ';'
	}" class="${'service flex svelte-14r4rp3'}"><div class="${'cricle left svelte-14r4rp3'}"></div>
		${(0, import_index_cb93fe8d.e)(title)}
		<div class="${'cricle right svelte-14r4rp3'}"></div></h3>
</a>`;
});
var LittleLoop_svelte_svelte_type_style_lang = /* @__PURE__ */ (() =>
	'p.svelte-1gpfu86{margin-right:2.4rem;text-align:right;font-size:1.32rem}p.svelte-1gpfu86::after{content:" - "}')();
const css$1 = {
...
<div class="${'container svelte-82sicn'}"><main class="${'c svelte-82sicn'}">${(0,
	import_index_cb93fe8d.b)(Servces, (s) => {
		return `<div class="${'svelte-82sicn'}">${(0, import_index_cb93fe8d.v)(
			Servce,
			'Servce'
		).$$render($$result, { url: s.url, title: s.title, bg: s.bg }, {}, {})}
				${(0, import_index_cb93fe8d.v)(LittleLoop, 'LittleLoop').$$render(
					$$result,
					{ i: s.subWork },
					{},
					{}
