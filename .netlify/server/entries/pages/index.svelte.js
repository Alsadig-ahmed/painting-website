...
const Servce = (0, import_index_5c544924.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a${(0, import_index_5c544924.a)("href", url, 0)} class="${"svelte-14r4rp3"}"><h3 style="${"background-color:" + (0, import_index_5c544924.e)(bg) + ";"}" class="${"service flex svelte-14r4rp3"}"><div class="${"cricle left svelte-14r4rp3"}"></div>
		${(0, import_index_5c544924.e)(title)}
...
const LittleLoop = (0, import_index_5c544924.c)(($$result, $$props, $$bindings, slots) => {
  let { i = [""] } = $$props;
  if ($$props.i === void 0 && $$bindings.i && i !== void 0)
    $$bindings.i(i);
  $$result.css.add(css$1);
  return `${(0, import_index_5c544924.b)(i, (item) => {
    return `<p class="${"svelte-1gpfu86"}">${(0, import_index_5c544924.e)(item)}</p>`;
  })}`;
});
...
const Routes = (0, import_index_5c544924.c)(($$result, $$props, $$bindings, slots) => {
  let Servces = [
    {
      url: "",
      title: "\u0639\u0645\u0644 \u062E\u0627\u0631\u062C\u064A",
...
${(0, import_index_5c544924.v)(import_Header_105ce7dd.H, "Header").$$render($$result, {}, {}, {})}

<div class="${"container svelte-82sicn"}"><main class="${"c svelte-82sicn"}">${(0, import_index_5c544924.b)(Servces, (s) => {
    return `<div class="${"svelte-82sicn"}">${(0, import_index_5c544924.v)(Servce, "Servce").$$render($$result, { url: s.url, title: s.title, bg: s.bg }, {}, {})}
				${(0, import_index_5c544924.v)(LittleLoop, "LittleLoop").$$render($$result, { i: s.subWork }, {}, {})}
			</div>`;
  })}</main>
</div>`;
});
