...
let img = "/home.jpg";
const UD9u81uD8uB1uD9u8AuD9u82_uD8uA7uD9u84uD8uB9uD9u85uD9u84 = (0, import_index_cb93fe8d.c)(($$result, $$props, $$bindings, slots) => {
  let supervisors = [
    {
      name: "\u0627\u0644\u0635\u0627\u062F\u0642 \u0623\u062D\u0645\u062F",
  ...
  $$result.css.add(css);
  return `${(0, import_index_cb93fe8d.v)(import_Header_61d4401f.H, "Header").$$render($$result, { title: "\u0641\u0631\u064A\u0642 \u0627\u0644\u0639\u0645\u0644" }, {}, {})}

<div class="${"container svelte-1pd15wp"}"><main class="${"c svelte-1pd15wp"}">${(0, import_index_cb93fe8d.b)(supervisors, (supervisor) => {
    return `${(0, import_index_cb93fe8d.v)(import_Card_32f008ff.C, "Card").$$render($$result, {
      img,
