...
const Card = (0, import_index_5c544924.c)(($$result, $$props, $$bindings, slots) => {
  let { text = "" } = $$props;
  let { url = "" } = $$props;
  ...
  if ($$props.img === void 0 && $$bindings.img && img !== void 0)
    $$bindings.img(img);
  $$result.css.add(css);
  return `<div class="${"c svelte-v2ra33"}"><a${(0, import_index_5c544924.a)("href", url, 0)} class="${"svelte-v2ra33"}">
		<img${(0, import_index_5c544924.a)("src", img, 0)}${(0, import_index_5c544924.a)("alt", text, 0)} class="${"svelte-v2ra33"}">
		<h3 class="${"svelte-v2ra33"}">${(0, import_index_5c544924.e)(text)}</h3></a>
</div>`;
});
