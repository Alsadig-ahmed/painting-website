...
${
	components[1]
		? `${(0, import_index_cb93fe8d.v)(
				components[0] || import_index_cb93fe8d.m,
				'svelte:component'
		  ).$$render(
				$$result,
				...
				{},
				{
					default: () => {
						return `${
							components[2]
								? `${(0, import_index_cb93fe8d.v)(
										components[1] || import_index_cb93fe8d.m,
										'svelte:component'
								  ).$$render(
										$$result,
										...
										{
											default: () => {
												return `${(0, import_index_cb93fe8d.v)(
													components[2] || import_index_cb93fe8d.m,
													'svelte:component'
